...
namespace DashNDine.CoreSystem
{
    public class SaveManager : SingletonBehaviour<SaveManager>
    {
        ...
        //             questSO.ID.ToString(),
        //             ConvertQuestObjectiveListToString(questSO.QuestObjectiveList),
        //             questSO.QuestStatus.ToString()
        //         });
        //     }
        ...
        // private string ConvertQuestObjectiveListToString(List<QuestObjective> questObjectiveList)
        // {
        //     string questObjectiveString = "";
        //     for (int i = 0; i < questObjectiveList.Count; i++)
        //     {
        //         if (i > 0 && i < questObjectiveList.Count)
        //             questObjectiveString += "|";

        //         QuestObjective questObjective = questObjectiveList[i];
        //         questObjectiveString += $"{questObjective.IngredientSO.ID}_{questObjective.CollectedAmount}";
        //     }
        ...
        //             questSO.ID = id;
        //             questSO.QuestObjectiveList = ConvertStringToQuestObjectiveList(questSO.QuestObjectiveList, values[1]);
        //             if (Enum.TryParse(values[2], out QuestStatus questStatus))
        //                 questSO.QuestStatus = questStatus;
        //             break;
        //     }
        // }
        
        // private List<QuestObjective> ConvertStringToQuestObjectiveList(List<QuestObjective> questObjectiveList, string value)
        // {
        ...
        //         {
        //             int index = questObjectiveList.FindIndex(qo => qo.IngredientSO.ID == ingredientID);
